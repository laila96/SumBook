            ...
            <tr>
                <td height="350px" valign="top" width="100%">
                    ...
                    <c:if test="${param.act eq 'sv'}">
                        <p class="success">Summary Saved Successfully</p>
                    </c:if>
                    <c:if test="${param.act eq 'del'}">
                        <p class="success">Summary Deleted Successfully</p>
                    </c:if>
                        ...
                        <table border="1" cellpadding="3"  width="100%">
                            ...
                            <c:forEach var="c" items="${contactList}" varStatus="st">
                                <tr>
                                    ...
                                    <td><a href="${url_edit}">contacter</a> | <a href="${url_del}">Commenter</a></td>
                                </tr> 
                            </c:forEach>
                        </table>
                    </form>     
